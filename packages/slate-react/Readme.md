> `slate-react-legacy` is a maintained OLD v0.13.0 version of `slate-react` with all subsequent patch versions signifying updates to dependencies and compatibility with newer React distributions.
